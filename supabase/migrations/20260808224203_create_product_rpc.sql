-- Migration: Create Product Full CRUD RPC
-- Description: Function to create or update a product along with prices and inventory.
...
BEGIN
  ...
  IF p_prices IS NOT NULL THEN
    ...
    LOOP
      -- Upsert price (since we have a unique index on product_id, price_list_id where valid_to is null)
...
GRANT EXECUTE ON FUNCTION public.create_or_update_product_full TO authenticated;
GRANT EXECUTE ON FUNCTION public.create_or_update_product_full TO service_role;
